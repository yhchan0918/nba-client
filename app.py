...
if uploaded_file is not None:
    ...
    def user_input_features():
        ...
        HOME_RECORD_prev_home = st.number_input("Home record on the previous season of Home Team")
        ROAD_RECORD_prev_home = st.number_input("Road record on the previous season of Home Team")
        ...
        HOME_RECORD_prev_away = st.number_input("Home record on the previous season of Away Team")
        ROAD_RECORD_prev_away = st.number_input("Road record on the previous season of Away Team")
        ...
        PTS_away_10g = st.number_input("Number of points scored by Away Team on previous 10 games")
...
if st.button("Predict"):
    response = requests.post("https://nba-api-server.herokuapp.com/predict", json=input_data)
